...
import { CheckCircle2, CreditCard, Lock, X, ShoppingCart } from "lucide-react";
...
export function Checkout({ courses, onBack }: CheckoutProps) {
  ...
  const handleCheckout = async () => {
    try {
      ...
      // ✅ CHECKOUT PRO: Abrir Mercado Pago em nova aba
                          ...
                          <div className="flex items-start gap-2 sm:gap-3">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-[10px] sm:text-xs text-gray-600 leading-relaxed">
                                Seus dados são protegidos e processados de forma segura. 
                                Você poderá escolher a forma de pagamento na próxima etapa.
                              </p>
                            </div>
                          </div>
                        </div>
